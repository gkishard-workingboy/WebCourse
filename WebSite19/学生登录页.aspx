<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学生登录页.aspx.cs" Inherits="学生登录页" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    body{
       background: url(images/pic2.jpg) no-repeat left center;
...
<div class="bg">
    <div class="login">
        <div class="box1">
            <h2 class="title">学生登录管理系统</h2>
        </div>
        <div class="box2">
            <img src="logo/BNF.png" alt="">
            <div class="head"> 账号登录</div>
            <div class="content">
            &nbsp;<asp:TextBox ID="idTxt" runat="server" placeholder="用户名"></asp:TextBox>
            </div> 
            <div class="content">
&nbsp;<asp:TextBox ID="pswTxt" runat="server" TextMode="Password" placeholder="密码"></asp:TextBox>
            </div> 
            <br/> 
